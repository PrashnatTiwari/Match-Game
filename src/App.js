...
class App extends Component {
  ...
  render() {
    const {timer, imgUrl, score, isTrue, category} = this.state
      ...
      <>
        <nav className="nav-container">
          ...
          <div className="score-timer-container">
            <p>
              Score: <span className="timer-count"> {score}</span>
            </p>
            <img
            ...
            <ul>
              ...
              <ul className="link-container">
                {tabsList.map(eachItem => (
                  <li className="link" key={eachItem.tabId}>
                    <button
                      type="button"
              ...
              <ul className="unordered-list-thumbnail-container">
                {thumbnailList.map(eachItem => (
                  <li key={eachItem.id} className="thumbnail-container ">
                    <button
                      type="button"
